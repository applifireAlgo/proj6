Ext.define("Proj6.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Proj6.view.clouddrive.CloudDriveController',
	             'Proj6.view.clouddrive.documentview.DocumentsView',
	             'Proj6.view.clouddrive.drivedetails.DriveDetails',
	             //'Proj6.view.clouddrive.documentview.DocumentListView'
	             ],
