Ext.define('Proj6.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Proj6.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Proj6.view.console.ConsoleWindow');
