 ...
 * 
 */
Ext.define('Proj6.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Proj6.view.securityconfig.SecurityConfigController',
			'Proj6.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
