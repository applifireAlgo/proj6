 ...
 * 
 */
Ext.define('Proj6.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Proj6.view.logalarm.mainscreen.AddLogAlarmController',
			'Proj6.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Proj6.view.logalarm.mainscreen.AppAlarmPanel',
