 ...
 * 
 */
Ext.define('Proj6.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Proj6.view.logalarm.LogAlarmMainViewController',
			'Proj6.view.logalarm.tree.LogAlarmTreePanel',
			'Proj6.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
