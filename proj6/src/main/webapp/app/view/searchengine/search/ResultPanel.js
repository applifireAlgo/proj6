Ext
		.define(
				'Proj6.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Proj6.view.searchengine.search.SearchEngineMainPanelController','Proj6.view.searchengine.search.PanelHeaderField' ,'Proj6.view.searchengine.search.ReportGridView','Proj6.view.searchengine.search.ReportChartView','Proj6.view.searchengine.search.documentView','Proj6.view.searchengine.search.DouMeanView','Proj6.view.googlemaps.map.MapPanel'],
