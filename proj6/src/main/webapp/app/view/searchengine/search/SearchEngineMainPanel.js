Ext.define('Proj6.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Proj6.view.searchengine.search.NorthPanel', 'Proj6.view.searchengine.search.SearchResult','Proj6.view.searchengine.search.SearchEngineMainPanelController'],
