Ext.define('Proj6.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Proj6.view.usermanagement.admin.UserPasswordReset',
	            'Proj6.view.usermanagement.admin.AddUserDetails',
	            'Proj6.view.usermanagement.admin.ViewUser'],
