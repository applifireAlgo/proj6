 ...
 * 
 */
Ext.define('Proj6.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Proj6.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
