...
Ext
		.define(
				'Proj6.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Proj6.view.logger.tabs.details.DetailsTab',
							'Proj6.view.logger.tabs.fileconnector.FileConnectorTab',
							'Proj6.view.logger.tabs.dbconnector.DBConnectorTab',
							'Proj6.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Proj6.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Proj6.view.logger.LogConfigurationTabPanelController',
