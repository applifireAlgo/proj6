...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestionIcon("aYWJuB5sDOEqCAAEl0Kpdh6G7UEwNnH8j1PzDk4DUW920xrFnE");
            question.setLevelid(6);
            question.setQuestionDetails("O");
            question.setQuestion("mG2KGvg2VwIzDvDNyki4h4DWvEPWFcaBla1kQKv9Qzn8PW5Mcm");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("LZFepxZhPkuYKo8SlaxNTcM9HygSetMVowNGix1zfcBLiubEU5");
            question.setLevelid(11);
            question.setQuestionDetails("Q");
            question.setVersionId(1);
            question.setQuestion("tUGhULjtmQkFezdA2SdvS8PnYMLBbdDr5gsrnlQbcvLv3vQo93");
