...
public class PasswordPolicyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            passwordpolicy.setAllowedSpecialLetters("LF7zMTDtPTqyM31BFddU3LQkP5rmHigvFbwp0znl9ZtDELz3Ua");
            passwordpolicy.setMaxPwdLength(25);
            passwordpolicy.setMinCapitalLetters(10);
            passwordpolicy.setMinSpecialLetters(7);
            passwordpolicy.setPolicyDescription("XczanHrA2MWzjQSpD1h863sffbgnt8BzznWWZoCDwLHDYtUErL");
            passwordpolicy.setMinNumericValues(10);
            passwordpolicy.setMinSmallLetters(11);
            passwordpolicy.setMinPwdLength(4);
            passwordpolicy.setPolicyName("hfPYHEU8I1FtkUsBqm4XFTXSFsOZN7u6ZAeV1rHrwtq72JuCt2");
    ...
    public void test2Update() {
        try {
            ...
            passwordpolicy.setAllowedSpecialLetters("nYN7SFom54ffH3G0IiE7YJd0VfG9YQgndgLxtGChU0IxFGeHfv");
            passwordpolicy.setMaxPwdLength(6);
            passwordpolicy.setMinCapitalLetters(8);
            passwordpolicy.setMinSpecialLetters(3);
            passwordpolicy.setPolicyDescription("7pur5umrRMMRvlUmfLesxttEeSLPvkRPpsGeSifDX45mmymR02");
            passwordpolicy.setVersionId(1);
            passwordpolicy.setMinNumericValues(6);
            passwordpolicy.setMinSmallLetters(7);
            passwordpolicy.setMinPwdLength(11);
            passwordpolicy.setPolicyName("zjZNY1Lga8vNenENl1dUrXWEjvJNyTNiCczhhO9MSkqvoYhL0y");
